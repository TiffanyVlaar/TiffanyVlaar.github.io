...
Lets start with the easiet method - pruning [4,5]. There are 4 steps:
<ol>
...
Pruning can result in networks with over 90% sparsity, without losing a noticeable amount of test accuracy compared to the original dense network. 
