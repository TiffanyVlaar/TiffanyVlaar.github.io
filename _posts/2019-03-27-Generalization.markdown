...
There are many other lines of research that propose complexity measures, but we haven't found our holy grail yet - our search for finding a complexity measure that can explain all generalizability features of neural networks continues. 
